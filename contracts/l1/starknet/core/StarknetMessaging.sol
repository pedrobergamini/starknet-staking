...
// Retrieved from https://github.com/immutable/imx-starknet/blob/179dbb16cfa78e4412f484e76e7c7e6882437652/immutablex/ethereum/starknet/core/StarknetMessaging.sol
...
contract StarknetMessaging is IStarknetMessaging {
    ...
    */
    ...
    function l1ToL2MessageCancellations() internal pure returns (mapping(bytes32 => uint256) storage) {
    ...
    */
    function consumeMessageFromL2(uint256 fromAddress, uint256[] calldata payload) external override returns (bytes32) {
        bytes32 msgHash = keccak256(
            abi.encodePacked(fromAddress, uint256(uint160(address(msg.sender))), payload.length, payload)
        );
